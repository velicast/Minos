...
${OBJECTDIR}/com/minos/checker/CheckerReply.o: com/minos/checker/CheckerReply.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/checker/CheckerReply.o com/minos/checker/CheckerReply.cpp

${OBJECTDIR}/com/minos/checker/TokenChecker.o: com/minos/checker/TokenChecker.cpp 
	${MKDIR} -p ${OBJECTDIR}/com/minos/checker
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/checker/TokenChecker.o com/minos/checker/TokenChecker.cpp

${OBJECTDIR}/com/minos/checker/main.o: com/minos/checker/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/com/minos/checker
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/checker/main.o com/minos/checker/main.cpp
