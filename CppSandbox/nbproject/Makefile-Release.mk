...
${OBJECTDIR}/com/minos/sandbox/Sandbox.o: com/minos/sandbox/Sandbox.cpp 
	...
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/sandbox/Sandbox.o com/minos/sandbox/Sandbox.cpp

${OBJECTDIR}/com/minos/sandbox/SandboxReply.o: com/minos/sandbox/SandboxReply.cpp 
	${MKDIR} -p ${OBJECTDIR}/com/minos/sandbox
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/sandbox/SandboxReply.o com/minos/sandbox/SandboxReply.cpp

${OBJECTDIR}/com/minos/sandbox/main.o: com/minos/sandbox/main.cpp 
	${MKDIR} -p ${OBJECTDIR}/com/minos/sandbox
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/sandbox/main.o com/minos/sandbox/main.cpp

${OBJECTDIR}/com/minos/sandbox/utils.o: com/minos/sandbox/utils.cpp 
	${MKDIR} -p ${OBJECTDIR}/com/minos/sandbox
	${RM} $@.d
	$(COMPILE.cc) -O2 -s -MMD -MP -MF $@.d -o ${OBJECTDIR}/com/minos/sandbox/utils.o com/minos/sandbox/utils.cpp
